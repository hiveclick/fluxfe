    ...
    static function loadDatabasesFromFile($filename) {
        ...
        foreach ($ini_file['databases'] as $key => $value) {
            if (isset($ini_file[$value])) {
                $db_array[$key]['user'] = $ini_file[$value]['param.user'];
                $db_array[$key]['pass'] = $ini_file[$value]['param.password'];
                $db_array[$key]['database'] = $ini_file[$value]['param.database'];
                $db_array[$key]['host'] = $ini_file[$value]['param.host'];
                $db_array[$key]['port'] = $ini_file[$value]['param.port'];
