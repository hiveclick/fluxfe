        ...
        <div class="container">
            <form name="mainForm" method="POST" class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-xs-12">
                        <div class="hc3">Status?</div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input type="submit" name="submit" value="SINGLE" class="btn-lg btn-block btn-custom" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input type="submit" name="submit" value="MARRIED" class="btn-lg btn-block btn-custom" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input type="submit" name="submit" value="FAMILY" class="btn-lg btn-block btn-custom" />
                    </div>
                </div>
            </form>
        </div>
