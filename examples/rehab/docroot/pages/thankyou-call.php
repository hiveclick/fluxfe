...
<script src="https://callpixels.com/insert.js?key=57cdd817c6da33b6ddde12674d61c901&default_number=" type="text/javascript"></script>
			...
			<div class="col-lg-8 col-lg-offset-2">
				...
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<center>
						...
						<h2> - or -</h2>
						<div class="btn btn-success btn-lg" id="callme">Please call me</div>
					</center>
				</div>
			</div>
		</div>
...
$(document).ready(function() {
	$('#callme').click(function() {
		$.post('https://callpixels.com/calls/new/for_number/3754180.json', {dial:'<?php echo $lead->getValue('phone') ?>'}, function(data) {});
	});
});
</script>
