	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-lg-offset-3">
				<h1 style="color:yellow">Now Accepting Patients Nationwide. <br>Find Out if You Qualify</h1><br>
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<form method="POST" action="">
						<input type="hidden" name="__submit" value="1" />
						<center><h2 style="color:white">Are you or a loved one suffering from a drug addiction?</h2><br /></center>
						<div class="row text-center">
							<div class="col-xs-6 ">
								<input type="submit" name="drug_addiction" value="YES" class="btn btn-danger btn-lg" />
							</div>
							<div class="col-xs-6">
								<input type="submit" name="drug_addiction" value="NO" class="btn btn-danger btn-lg" />
							</div>
						</div>
					</form>
				</div>
...
<div class="section-b">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6">
				<img class="img-responsive" src="/img/hands.jpg" alt="Logo">
			</div>
		</div>
	</div>
</div>
