	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<h3 style="text-align:center">Question 3 of 8</h3>
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<form id="myform" method="POST" action="">
						<input type="hidden" name="__submit" value="1" />
						<center><h2 style="color:white">What is the individuals current age?</h2><br /></center>
						<div class="row text-center">
							<div class="col-md-6 col-md-offset-3 ">
								<div class="form-group"><input type="text" class="form-control input-lg" name="patient_age" value="" placeholder="Age"></div><br>
							</div>
							<div class="col-xs-12">
