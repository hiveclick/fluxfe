	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<h3 style="text-align:center">Question 6 of 8</h3>
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<form method="POST" action="" id="myform">
						<input type="hidden" name="__submit" value="1" />
						<center><h2 style="color:white">If so, how many times?</h2><br /></center>
						<div class="row text-center">
							<div class="col-md-6 col-md-offset-3">
								<div class="form-group"><input type="text" class="form-control input-lg" name="times_attended_treatment" value="" placeholder="Number of Visits to Rehab"></div>
							</div>
							<div class="col-xs-12">
								<input type="submit" name="btn_submit" value="NEXT" class="btn btn-danger btn-lg" />
							</div>
						</div>
					</form>
				</div>
...
$('#myform').bootstrapValidator({
	...
	fields: {
		...
		times_attended_treatment: {
			validators: {
				notEmpty: {
					message: 'Please enter the number of previous visits'
				}
			}
		},
	},
