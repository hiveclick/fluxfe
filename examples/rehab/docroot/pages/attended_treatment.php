	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<h3 style="text-align:center">Question 3 of 12</h3>
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<form method="POST" action="">
						<input type="hidden" name="__submit" value="1" />
						<center><h2 style="color:white">Has this individual ever been admitted to a rehabilitation facility?</h2><br /></center>
						<div class="row text-center">
							<div class="col-xs-6 ">
								<input type="submit" name="attended_treatment" value="YES" class="btn btn-danger btn-lg" />
							</div>
							<div class="col-xs-6">
								<input type="submit" name="attended_treatment" value="NO" class="btn btn-danger btn-lg" />
							</div>
						</div>
					</form>
				</div>
