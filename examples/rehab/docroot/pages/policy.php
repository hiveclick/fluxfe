	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<h3 style="text-align:center">Question 5 of 12</h3>
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<form method="POST" action="">
						<input type="hidden" name="__submit" value="1" />
						<center><h2 style="color:white">Is this coverage a PPO or HMO policy?</h2><br /></center>
						<div class="row text-center">
							<div class="col-xs-4">
								<input type="submit" name="policy" value="PPO" class="btn btn-danger btn-lg" />
							</div>
							<div class="col-xs-4">
								<input type="submit" name="policy" value="HMO" class="btn btn-danger btn-lg" />
							</div>
							<div class="col-xs-4">
								<input type="submit" name="policy" value="NONE" class="btn btn-danger btn-lg" />
							</div>
						</div>
					</form>
				</div>
