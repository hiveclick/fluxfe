	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<h3 style="text-align:center">Question 10 of 12</h3>
				<div class="well well-lg" style="background-color: rgba(0, 0, 0, 0.6);">
					<form id="myform" method="POST" action="">
						<input type="hidden" name="__submit" value="1" />
						<center><h2 style="color:white">Please enter your primary phone number:</h2><br /></center>
						<div class="row text-center">
							<div class="col-md-6 col-md-offset-3">
								<div class="form-group"><input type="tel" class="form-control input-md" id="phone1" name="phone1"  value="" placeholder="Phone Number"></div>
							</div>
							<div class="col-xs-12">
